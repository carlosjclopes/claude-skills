...
1. Identifique explicitamente o que está ausente
2. Solicite apenas o que é necessário para avançar
3. Se o usuário não tiver o dado, use benchmarks setoriais — sinalizando claramente: *"[ESTIMATIVA com base em benchmark de consultórios de [especialidade] no Brasil — substituir pelo dado real quando disponível]"*
